...
for plotNum in range(len(inFiles)):
    ...
    title = ["Harvest Random","Harvest with Sickle", "Harvest Random\n     + Planting", "Harvest with Sickle\n       + Planting"]
    title_pos = [40,10,40,10]
    ...
    if plotNum//cols == rows - 1:
        axes.set_xticks([35,350],["50k","150k"], rotation = 0) #[25,370] with 3
    else:
...
f = plt.figure(num=1)
plt.savefig("sickles.png")
plt.savefig("sickles.pdf")
