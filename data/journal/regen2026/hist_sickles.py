...
for plotNum in range(len(inFiles)):
    ...
    if plotNum//cols == rows - 1:
        axes.set_xticks([20,175],["50k","100k"], rotation = 0) #[25,370] with 3
    else:
    ...
    if plotNum%cols == 0: # first column titles
        axes.text(-47, inTitle_pos[plotNum//cols], inTitle[plotNum//cols], fontsize=10, rotation=90)
    if plotNum == cols:
        axes.text(-73, 30, "Gene Value", fontsize=10, rotation=90)
